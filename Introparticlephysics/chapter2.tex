...
Problem 2.5 \\
(a) Which decay do you think would be more likely, \\
\[ \Xi^- \rightarrow \Lambda + \pi^-  \ \textnormal{or} \ \ \Xi^- \rightarrow n + \pi^- \] \\ 
Explain your answer, and confirm it by looking up the experimental data. \\
(b) Which decay of the $D^0$(c$\bar{u}$) meson is most likely,\\
\[ D^0 \rightarrow K^- + \pi^+ , \ \ D^0 \rightarrow \pi^- + \pi^+ , \  \textnormal{or} \ \ D^0 \rightarrow K^+ + \pi^- \] \\ 
Which is least likely? Draw the Feynman diagrams, explain your answer and check the experimental data. (One of the successful predictions of the Cabibbo/GIM/KM model was that charmed mesons should decay preferentially into strange mesons, even though enegetically the 2$\pi$ mode is favored.)\\
(c) How about the `beautiful' (B) mesons? Should they go to the $D$'s, $K$'s, or $\pi$'s?\\  \\ \\ 

Solution \\
(a) \\
\( \Xi^- = dss \) : charge = -1, mass = 1321.3 and  \(\pi^- = d\bar{u} \) : charge = -1, mass = 139.570 and \(\Lambda = uds \) : charge = 0, mass = 1115.68 , and \( n = udd \) : charge = 0, mass = 939.565 \\
 
Q. What factors affect the likelihood for an interaction? \\
A. 
