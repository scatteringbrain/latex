...
Problem 6.\\
The mass formula for decuplets is much simpler - equal spacing between the rows: \\
\[ m_{\triangle} - m_{\Sigma^*} = m_{\Sigma^*} - m_{\Xi^*} = m_{\Xi^*} - m_{\Omega}\] \\
Use this formula (as Gell-Mann did) to predict the mass of the $\Omega^-$. (Use the average of the first two spacings to estimate the third.) How close is your prediction to the observed value? \\ \\
Solution\\
 \begin{figure}
  ...
  \label{fig:decuplet}
\end{figure}
Using the mass table in this book, \\
 \begin{figure}
  \includegraphics[width=\linewidth]{du2.png}
  \caption{decuplet2}
  \label{fig:decuplet2}
\end{figure}
\(m_{\triangle} - m_{\Sigma^*} = 1232 - 1385 = -153 MeV/c^2 \) \\
\(m_{\Sigma^*} - m_{\Xi^*} = 1385 - 1533 = - 148 MeV/c^2 \) \\
Using the average of the first two gaps = \(\frac{-153 - 148}{2} = - 150.5 MeV/c^2  \)\\

\(m_{\Xi^*} - m_{\Omega} = -150.5 MeV/c^2,\)
So, the $m_{\Omega^-}$ = 1533 + 150.5 = 1683.5 MeV. \\  
The experimental value, 1672 $MeV/c^2$ is very close from the expected value, 1683.5 $MeV/c^2$ \\ 
