...
\(\tau = \frac{1}{\Gamma}\)\\ 
$t_{1/2}$ is the time when N(t) = $\frac{N(0)}{2}$ \\
So, \(N(t_{1/2}) = N(0)e^{-\Gamma t_{1/2}} = N(0)/2 \)\\
Then, \(e^{-\Gamma t_{1/2}} = \frac{1}{2} \) \\ 
Taking $\ln$ for both sides, \(-\Gamma t_{1/2} = \ln{\frac{1}{2}}\)\\
\(t_{1/2} =  \frac{\log{2}}{\Gamma} = \tau\ln{2} \) \\ 
%There are different routes for the decays : \\
%\(\Gamma_{tot} = \sum_{i=1}^{n} \Gamma_i\)\\
%And the life time is \\
